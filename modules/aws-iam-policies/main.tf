...
#
# Creates three IAM roles in the management account that allow cross-account
# access into the provisioned account. Each role maps to a CyberArk Identity
# tier so that CyberArk controls who can assume the role.
#
# Role mapping:
